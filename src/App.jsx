...
const SOW_TEMPLATES = {
  "Residential Interior": {
    items: [
      { text: "Тип простору (житловий)", cat: "Вимоги клієнта" },
      { text: "Креслення плану з розміщенням меблів (DWG або PDF) — обов'язково", cat: "Креслення" },
      { text: "Відбивний план / схема освітлення (RCP)", cat: "Креслення" },
      { text: "Настінні розгортки (для просторів з нішами або складним оздобленням)", cat: "Креслення" },
      { text: "Ракурси камер / переваги кутів зйомки", cat: "Вимоги клієнта" },
      { text: "Меблі та декор — посилання, бренди, розміри для кожної позиції", cat: "Меблі та предмети" },
      { text: "Оздоблення підлоги — посилання або фото у хорошій якості", cat: "Матеріали та оздоблення" },
      { text: "Оздоблення стін — посилання або фото у хорошій якості", cat: "Матеріали та оздоблення" },
      { text: "Оздоблення стелі — посилання або фото у хорошій якості", cat: "Матеріали та оздоблення" },
      { text: "Предмети / аксесуари — фото або посилання", cat: "Меблі та предмети" },
      { text: "Вид з вікна / фон (за замовчуванням обирається за локацією проекту)", cat: "Референси" },
      { text: "Настрій / час доби (день за замовчуванням; вечір або ніч — за запитом)", cat: "Референси" },
      { text: "Референси стилю та атмосфери", cat: "Референси" },
      { text: "Роздільність: 4K / 5K / 8K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG / TIFF", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 9x16 / 4x3", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / соцмережі / презентація / друк", cat: "Технічні вимоги" },
  ...
  "Commercial Interior": {
    items: [
      { text: "Тип простору (комерційний)", cat: "Вимоги клієнта" },
      { text: "Креслення плану з зонуванням та розміщенням обладнання (DWG або PDF) — обов'язково", cat: "Креслення" },
      { text: "Відбивний план / схема освітлення (RCP)", cat: "Креслення" },
      { text: "Настінні розгортки (для просторів з нішами або складним оздобленням)", cat: "Креслення" },
      { text: "Ракурси камер / переваги кутів зйомки", cat: "Вимоги клієнта" },
      { text: "Концепція бренду / фірмові кольори / гайдлайн", cat: "Вимоги клієнта" },
      { text: "Логотип та написи (вектор або PNG з прозорим фоном)", cat: "Меблі та предмети" },
      { text: "Меблі та обладнання — посилання, бренди, розміри", cat: "Меблі та предмети" },
      { text: "Оздоблення підлоги, стін, стелі — посилання або фото", cat: "Матеріали та оздоблення" },
      { text: "Предмети / аксесуари — фото або посилання", cat: "Меблі та предмети" },
      { text: "Наявність людей на рендері", cat: "Вимоги клієнта" },
      { text: "Вид з вікна / фон", cat: "Референси" },
      { text: "Настрій / час доби (день за замовчуванням)", cat: "Референси" },
      { text: "Референси стилю та атмосфери", cat: "Референси" },
      { text: "Роздільність: 4K / 5K / 8K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG / TIFF", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
  ...
  "Exterior": {
    items: [
      { text: "Тип об'єкту (житловий / комерційний)", cat: "Вимоги клієнта" },
      { text: "Креслення: плани, фасади, розрізи (DWG або PDF) — обов'язково", cat: "Креслення" },
      { text: "CAD-модель (опційно): RVT, SKP, FBX — прискорює проект і знижує вартість", cat: "Креслення" },
      { text: "Фото ділянки / фото існуючого об'єкту", cat: "Креслення" },
      { text: "Локація проекту (для підбору оточення та неба)", cat: "Вимоги клієнта" },
      { text: "Переваги кутів камер", cat: "Вимоги клієнта" },
      { text: "Матеріали оздоблення фасаду — специфікація або фото з прикладами", cat: "Матеріали та оздоблення" },
      { text: "Ландшафтний план: тверде покриття, рослинність, розміщення", cat: "Креслення" },
      { text: "Настрій / освітлення / сезон (за замовчуванням: літо, день)", cat: "Референси" },
      { text: "Референси з коментарями — що саме взяти з кожного (небо, вода, дорога, трава, люди, матеріали)", cat: "Референси" },
      { text: "Погодні умови та атмосфера", cat: "Референси" },
      { text: "Наявність людей / транспорту на рендері", cat: "Вимоги клієнта" },
      { text: "Роздільність: 4K / 5K / 8K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG / TIFF", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 9x16 / 4x3 / 3x2", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / соцмережі / презентація", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
      "--- AERIAL / АЕРІАЛ (дрон-вид) ---",
      { text: "Aerial: висота та кут дрону (для аеріал-ракурсів)", cat: "Вимоги клієнта" },
      { text: "Aerial: наявність хмар на небі", cat: "Референси" },
      { text: "Aerial: автомобілі на паркінгу (статичні / без авто)", cat: "Вимоги клієнта" },
    ],
    defaults: {
      "Роздільність": "4K",
      "DPI": "72 dpi (онлайн)",
  ...
  "Lifestyle": {
    items: [
      { text: "Тип сцени (інтер'єр / вулиця)", cat: "Вимоги клієнта" },
      { text: "Тип workflow: Our Vision / Your Vision / Template", cat: "Вимоги клієнта" },
      "--- OUR VISION (спрощений бриф) ---",
      { text: "Специфікація 3D-моделей — посилання, бренд, розміри, текстури", cat: "Меблі та предмети" },
      { text: "Загальні побажання та референси стилю з коментарями що саме взяти", cat: "Референси" },
      "--- YOUR VISION (стандартний бриф) ---",
      { text: "Специфікація 3D-моделей — посилання, бренд, розміри, текстури", cat: "Меблі та предмети" },
      { text: "Схема розміщення меблів з позначеннями", cat: "Креслення" },
      { text: "Специфікація оздоблення: колір стін, шпалери, панелі — посилання", cat: "Матеріали та оздоблення" },
      { text: "Референс базового зображення з коментарями що додати / прибрати", cat: "Референси" },
      { text: "Декорування: подушки, рослини, аксесуари — посилання або з бібліотеки", cat: "Меблі та предмети" },
      "--- TEMPLATE (шаблонна сцена) ---",
      { text: "Специфікація 3D-моделей — посилання, бренд, розміри", cat: "Меблі та предмети" },
      { text: "Вибір шаблонної сцени з бібліотеки", cat: "Вимоги клієнта" },
      { text: "Опис змін до шаблону (до 30%)", cat: "Вимоги клієнта" },
      "--- ЗАГАЛЬНЕ ---",
      { text: "3D-модель продукту: надає клієнт (.3ds) або моделюємо з нуля", cat: "Меблі та предмети" },
      { text: "Якщо модель від клієнта: відповідність референсам, відсутність дефектів геометрії", cat: "Вимоги клієнта" },
      { text: "Текстури та кольори: фото продукту з усіх сторін + деталі крупним планом", cat: "Матеріали та оздоблення" },
      { text: "Якщо продукту немає: посилання на матеріали (від 2000x2000px) + HEX-коди", cat: "Матеріали та оздоблення" },
      { text: "Настрій / час доби (день за замовчуванням; ранок або вечір — за запитом)", cat: "Референси" },
      { text: "Роздільність: 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат: JPG / PNG / TIFF", cat: "Технічні вимоги" },
      { text: "DPI: 72 / 300", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 9x16 / 4x3 / 1x1", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
    defaults: {
  ...
  "Silo": {
    items: [
      ...
      { text: "Текстури та кольори: фото продукту з усіх сторін + деталі крупним планом", cat: "Матеріали та оздоблення" },
      { text: "Якщо продукту немає: посилання на матеріали (від 2000x2000px) + HEX-коди", cat: "Матеріали та оздоблення" },
      { text: "Кути зйомки: Front / Side / Top / Back / Corner ¾ / Hero Shot / Close-up / Feature Callout / Component View / Dimension Image / Product Set / Size & Proportion", cat: "Вимоги клієнта" },
      { text: "Тінь: без тіні (за замовчуванням) / під об'єктом / праворуч / ліворуч", cat: "Вимоги клієнта" },
      { text: "Фон: білий (за замовчуванням) / чорний / прозорий / інший (HEX-код)", cat: "Вимоги клієнта" },
      { text: "Роздільність: 2K / 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG / TIF / PSD", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 9x16 / 4x3 / 1x1", cat: "Технічні вимоги" },
      { text: "Найменування файлів: стандартне (ID задачі + кут) / інше", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / презентація / каталог", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
    defaults: {
      "Роздільність": "4K",
  ...
  "3D Modeling": {
    items: [
      { text: "Призначення моделі: рендеринг / AR / VR / анімація / 3D-друк", cat: "Вимоги клієнта" },
      { text: "Ліміт полігонів: без ліміту / до [X]", cat: "Технічні вимоги" },
      { text: "Вихідний формат файлу: .max / .fbx / .obj", cat: "Технічні вимоги" },
      { text: "Метод UV-розгортки: Tiling / RealWorld", cat: "Технічні вимоги" },
      { text: "Тип матеріалу: Corona / V-Ray / інше", cat: "Технічні вимоги" },
      { text: "Формат сітки: трикутники / прямокутники", cat: "Технічні вимоги" },
      { text: "Рівень деталізації: Low / Medium / High", cat: "Технічні вимоги" },
      { text: "Креслення або CAD-модель (DWG, PDF, wireframe)", cat: "Креслення" },
      { text: "Якщо креслень немає: габарити продукту (висота / ширина / глибина) + одиниці виміру (мм / см / дюйми)", cat: "Вимоги клієнта" },
      { text: "Розміри кожної частини продукту окремо", cat: "Вимоги клієнта" },
      { text: "Фото продукту: вигляд спереду, збоку, ззаду, кут 3/4", cat: "Меблі та предмети" },
      { text: "Фото деталей крупним планом", cat: "Меблі та предмети" },
      { text: "Текстури та кольори: фото продукту в потрібному матеріалі", cat: "Матеріали та оздоблення" },
      { text: "Якщо матеріалу немає: посилання на матеріали (від 2000x2000px) + HEX-коди", cat: "Матеріали та оздоблення" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
      "--- AR (доповнена реальність) ---",
      { text: "AR: вихідний формат: USDZ (iOS) + GLB (Android/Web)", cat: "Технічні вимоги" },
      { text: "AR: ліміт розміру файлу (рекомендовано до 10 MB)", cat: "Технічні вимоги" },
      { text: "AR: роздільність текстур (рекомендовано 2048×2048 px)", cat: "Технічні вимоги" },
      { text: "AR: ліміт полігонів (mid-poly: 15,000–50,000)", cat: "Технічні вимоги" },
      { text: "AR: UV-розгортка: Atlas (одна карта на об'єкт)", cat: "Технічні вимоги" },
      { text: "AR: тип матеріалу: PBR (Physically Based Rendering)", cat: "Технічні вимоги" },
    ],
    defaults: {
  ...
  "Floorplan": {
    items: [
      { text: "Креслення плану (DWG або PDF) — обов'язково", cat: "Креслення" },
      { text: "Меблювання: з меблями / без / мінімальне", cat: "Вимоги клієнта" },
      { text: "Тип подачі: 3D перспектива / 2D схема / 3D зверху", cat: "Вимоги клієнта" },
      { text: "Рівень деталізації: High / Medium / Low", cat: "Технічні вимоги" },
      { text: "Фон: білий / прозорий / кольоровий", cat: "Вимоги клієнта" },
      { text: "Стиль: реалістичний 3D / схематичний / дизайнерський", cat: "Вимоги клієнта" },
      { text: "Покажчики розмірів (розміри приміщень — присутні / відсутні)", cat: "Вимоги клієнта" },
      { text: "Назви приміщень: присутні / відсутні", cat: "Вимоги клієнта" },
      { text: "Роздільність: FullHD / 4K", cat: "Технічні вимоги" },
      { text: "Формат файлу: PNG / JPEG / PDF", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / презентація / поліграфія", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
    defaults: {
  ...
  "Aerial": {
    items: [
      { text: "Тип об'єкту (будівля / ландшафт / комплекс)", cat: "Вимоги клієнта" },
      { text: "Координати локації або адреса об'єкту", cat: "Вимоги клієнта" },
      { text: "Висота дрону: 30м / 50м / 75м / 100м", cat: "Вимоги клієнта" },
      { text: "Кут камери: 15° / 30° / 45° / 60° / 90° (вертикально вниз)", cat: "Вимоги клієнта" },
      { text: "Переваги ракурсів / сторони огляду (північ, південь тощо)", cat: "Вимоги клієнта" },
      { text: "Сезон: весна / літо / осінь / зима", cat: "Референси" },
      { text: "Час доби: ранок / день / після полудня / захід / ніч", cat: "Референси" },
      { text: "Атмосфера: ясно / хмарно / туман / дощ / сніг", cat: "Референси" },
      { text: "Наявність автомобілів на паркінгу: є / без авто / статичні", cat: "Вимоги клієнта" },
      { text: "Наявність людей: є / без людей", cat: "Вимоги клієнта" },
      { text: "Роздільність: FullHD (1920×1080) / 4K", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / соцмережі / презентація", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
  ...
  "Design Interior": {
    items: [
      { text: "Тип об'єкту: житловий / комерційний", cat: "Вимоги клієнта" },
      { text: "Стиль: Contemporary / Farmhouse / Modern / Scandinavian / Traditional / Transitional / Luxury", cat: "Вимоги клієнта" },
      { text: "Простори для візуалізації (вітальня, кухня, спальня, ванна тощо)", cat: "Вимоги клієнта" },
      { text: "Рівень бюджету: Economy / Mid-Range / High-End / Luxury", cat: "Вимоги клієнта" },
      { text: "Ескіз або схема планування (необов'язково — студія розробляє концепцію самостійно)", cat: "Креслення" },
      { text: "Побажання щодо кольорової палітри", cat: "Вимоги клієнта" },
      { text: "Побажання щодо фактур та матеріалів", cat: "Матеріали та оздоблення" },
      { text: "Побажання щодо освітлення та настрою", cat: "Референси" },
      { text: "Референси стилю (Pinterest, Houzz тощо) — з коментарями що саме взяти", cat: "Референси" },
      { text: "Кількість варіантів концепції", cat: "Технічні вимоги" },
      { text: "Наявність людей на рендері", cat: "Вимоги клієнта" },
      { text: "Роздільність: 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 9x16 / 4x3", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / соцмережі / презентація / продаж нерухомості", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
    defaults: {
  ...
  "Floor Rendering": {
    items: [
      { text: "Тип поверхні: підлогова плитка / настінна плитка / паркет / ламінат / вінілове покриття", cat: "Матеріали та оздоблення" },
      { text: "Розмір та формат плитки (наприклад: 600×600 мм / 1200×600 мм)", cat: "Матеріали та оздоблення" },
      { text: "Укладання: пряме / зі зміщенням (brick) / діагональне / ялинка / інше", cat: "Матеріали та оздоблення" },
      { text: "Ширина та колір затирки", cat: "Матеріали та оздоблення" },
      { text: "Фото матеріалу або посилання на продукт (від 2000×2000px)", cat: "Матеріали та оздоблення" },
      { text: "3D-модель продукту: надає клієнт або моделюємо", cat: "Меблі та предмети" },
      { text: "Тип зображень: silo (на білому) / lifestyle сцена / обидва", cat: "Вимоги клієнта" },
      { text: "Lifestyle сцена: ванна / кухня / вітальня / комбінована", cat: "Вимоги клієнта" },
      { text: "Кут зйомки: top-down / perspective / крупний план текстури", cat: "Вимоги клієнта" },
      { text: "Кількість варіантів кольору або фактури", cat: "Технічні вимоги" },
      { text: "Роздільність: 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк / каталог)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 1x1 / 4x3", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / каталог / соцмережі", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
    defaults: {
  ...
  "Mattress Rendering": {
    items: [
      { text: "3D-модель матраца: надає клієнт (.fbx / .obj / .3ds) або моделюємо з нуля", cat: "Меблі та предмети" },
      { text: "Фото матраца з усіх сторін (front, side, top, 3/4 corner)", cat: "Меблі та предмети" },
      { text: "Фото деталей крупним планом: тканина, кант, ручки, пружини (якщо видно)", cat: "Меблі та предмети" },
      { text: "Специфікація матеріалів / тканин: фото або посилання (від 2000×2000px) + HEX-коди", cat: "Матеріали та оздоблення" },
      { text: "Конструктивний розріз (cross-section) — якщо потрібне зображення шарів", cat: "Вимоги клієнта" },
      { text: "Тип зображень: silo / lifestyle / обидва", cat: "Вимоги клієнта" },
      { text: "Постільна білизна: з повним комплектом / тільки простирадло / без білизни", cat: "Матеріали та оздоблення" },
      { text: "Якщо з білизною: фото або референс кольору / фактури тканини", cat: "Матеріали та оздоблення" },
      { text: "Lifestyle сцена: спальня / нейтральний фон / інше", cat: "Вимоги клієнта" },
      { text: "Ракурси: фронт / збоку / 3/4 / top-down / hero shot / крупний план", cat: "Вимоги клієнта" },
      { text: "Кількість колірних варіантів / артикулів", cat: "Технічні вимоги" },
      { text: "Роздільність: 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG / PSD", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (каталог / друк)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 1x1 / 4x3", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / каталог / соцмережі", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
  ...
  "Rugs Rendering": {
    items: [
      { text: "3D-модель килима: надає клієнт або моделюємо", cat: "Меблі та предмети" },
      { text: "Фото або скан килима (вид зверху, крупний план фактури) — від 2000×2000px", cat: "Матеріали та оздоблення" },
      { text: "Точні розміри: ширина × довжина (мм або см)", cat: "Вимоги клієнта" },
      { text: "Ворс: висота / тип (cut pile, loop, shaggy, flat weave тощо)", cat: "Матеріали та оздоблення" },
      { text: "Кількість кольорових варіантів / артикулів", cat: "Технічні вимоги" },
      { text: "Ракурси: вид зверху (top-down) / крупний план фактури / lifestyle сцена", cat: "Вимоги клієнта" },
      { text: "Lifestyle сцена: вітальня / спальня / вхідна зона / нейтральний фон", cat: "Вимоги клієнта" },
      { text: "Меблі в lifestyle сцені: з меблями з бібліотеки / без меблів", cat: "Меблі та предмети" },
      { text: "Роздільність: 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат файлу: PNG / JPEG", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (каталог)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 1x1 / 4x3", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: сайт / каталог / соцмережі", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
  ...
  "Real Estate": {
    items: [
      { text: "Тип нерухомості: квартира / кондо / приватний будинок / житловий комплекс", cat: "Вимоги клієнта" },
      { text: "Ринковий сегмент: Economy / Mid-Range / High-End / Luxury / Ultra-Luxury", cat: "Вимоги клієнта" },
      { text: "Простори для візуалізації: вітальня / кухня / спальня / ванна / вхідна зона / тераса / інше", cat: "Вимоги клієнта" },
      { text: "Вхідні матеріали: 2D план / ескіз планування (DWG або PDF)", cat: "Креслення" },
      { text: "Якщо повних креслень немає: схема з розмірами приміщень (навіть від руки)", cat: "Креслення" },
      { text: "Стиль: студія пропонує референси самостійно / є побажання клієнта", cat: "Вимоги клієнта" },
      { text: "Якщо є побажання: референси (Pinterest, Houzz) — з коментарями що взяти", cat: "Референси" },
      { text: "Меблі та матеріали: студія підбирає з бібліотеки / є специфікація від клієнта", cat: "Меблі та предмети" },
      { text: "Кольорова палітра: нейтральна (для продажу) / акцентна (за смаком клієнта)", cat: "Вимоги клієнта" },
      { text: "Вид з вікна: за локацією проекту / конкретний референс", cat: "Референси" },
      { text: "Час доби / освітлення: день / вечір / ніч", cat: "Референси" },
      { text: "Наявність людей на рендері", cat: "Вимоги клієнта" },
      { text: "Роздільність: 4K / 5K", cat: "Технічні вимоги" },
      { text: "Формат файлу: JPEG / PNG", cat: "Технічні вимоги" },
      { text: "DPI: 72 (онлайн) / 300 (друк)", cat: "Технічні вимоги" },
      { text: "Співвідношення сторін: 16x9 / 9x16 / 4x3", cat: "Технічні вимоги" },
      { text: "Кількість зображень", cat: "Технічні вимоги" },
      { text: "Призначення: продаж нерухомості / сайт / соцмережі / презентація", cat: "Технічні вимоги" },
      { text: "Дедлайн", cat: "Технічні вимоги" },
    ],
    defaults: {
...
- ВАЖЛИВО: в SOW-шаблоні кожен пункт має мітку [кат]. Використовуй саме цю категорію для відповідного item. Якщо вимога не є частиною шаблону — обери найближчу категорію самостійно.
